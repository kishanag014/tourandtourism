...
public class DeletePersonalDetails extends JFrame implements ActionListener{
    ...
    DeletePersonalDetails(String username){
        ...
        labelcountry.setBounds(690,50,410,25);
        add(labelcountry);  
        ...
        labeladdress.setBounds(690,110,410,25);
        add(labeladdress); 
        ...
        labelphone.setBounds(690,170,410,25);
        add(labelphone);
        ...
        labelemail.setBounds(690,230,410,25);
        add(labelemail);
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            JOptionPane.showMessageDialog(null,"Your Data Delete Sucessfully");
