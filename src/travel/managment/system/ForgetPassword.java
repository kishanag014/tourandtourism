...
public class ForgetPassword extends JFrame implements ActionListener{
    ...
    ForgetPassword(){
        ...
        lblusename.setBounds(40,20,100,25);
...
//         security=new Choice();
//        security.add("Favourite Character from the Cartoon");
//        security.add("Favourite SportsPerson");
//        security.add("Your Favourite City");
//        security.add("Who is your Inspiration");
//        security.setBounds(220,100,150,25);
//        p1.add(security);
