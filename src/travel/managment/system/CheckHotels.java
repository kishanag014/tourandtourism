...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text=new String[]{"SIX SENSES PUNAKHA HOTEL","HOTEL BROOKLYN BRIDGE","JADE MOUNTAIN HOTEL","THE OBEROI AMARVILAS HOTEL","BELEZA BY THE BEACH HOTEL","PARIMROSE VILLAS HOTEL"," SEA FRONT HOTEL","THE ELGIN HOTEL","NIRAVAANA RESORT","SEA GREEN HOTEL"};
        try{
