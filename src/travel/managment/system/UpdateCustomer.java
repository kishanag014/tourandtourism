...
public class UpdateCustomer extends JFrame implements ActionListener{
    ...
    UpdateCustomer(String username){
        ...
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("icons/update2.jpg"));
        Image i2=i1.getImage().getScaledInstance(400,350,Image.SCALE_DEFAULT);
        ImageIcon i3=new ImageIcon(i2);
        JLabel image=new JLabel(i3);
        image.setBounds(450,80,250,400);
        add(image);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==add){
            ...
            try{
                Conn c=new Conn();
                String query = "update  customer set username='"+username+"',id= '"+id+"' , number= '"+number+"', name= '"+name+"', gender= '"+gender+"', countery= '"+country+"', address= '"+address+"', phone= '"+phone+"', email= '"+email+"'";
